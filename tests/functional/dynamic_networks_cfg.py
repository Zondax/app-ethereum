...
# BOLOS_SDK=/opt/ledger-secure-sdk tools/gen_dynamic_network.py -i glyphs/chain_3_64px.gif
...
def get_network_config(dev_type: DeviceType, chain_id: int | None = None) -> tuple[str, str, bytes]:
